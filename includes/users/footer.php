            ...
            <div class="f_widgets_inner row">
                ...
                <div class="col-lg-3 col-md-6">
                    <aside class="f_widget contact_widget">
                        ...
                        <a href="#">+628 23600 62978</a>
                        <a href="#">casheycash@gmail.com</a>
                        <p>Jalan Tgk. Syech Abdul Rauf(Darussalam) Kode Pos: 23111 <br />Banda Aceh , Aceh</p>
                    </aside>
                </div>
            </div>
        </div>
    ...
    <div class="copy_right_area">
        <div class="container">
            <div class="float-md-left">
                <h5>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> developed by CasheyCash</h5>
            </div>
