        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Tambah Planning</h3> 
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo $config['site_url']?>dashboard">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="<?php echo $config['site_url']?>planning">Planning</a></li>
                        <li class="breadcrumb-item active">Tambah Planning</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                                ...
                                <div class="basic-form">
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-2 control-label">Rencana</label>
                                                <div class="col-sm-10">
